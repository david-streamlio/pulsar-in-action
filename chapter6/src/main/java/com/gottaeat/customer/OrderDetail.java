...
public class OrderDetail extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5443177467085528891L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderDetail\",\"namespace\":\"com.gottaeat.customer\",\"fields\":[{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"total\",\"type\":\"float\"},{\"name\":\"food_item\",\"type\":{\"type\":\"record\",\"name\":\"FoodItem\",\"fields\":[{\"name\":\"item_id\",\"type\":\"long\"},{\"name\":\"item_name\",\"type\":\"string\"},{\"name\":\"item_description\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"float\"}]}}]}");
  ...
  @Deprecated public com.gottaeat.customer.FoodItem food_item;
   ...
   */
  public OrderDetail(java.lang.Integer quantity, java.lang.Float total, com.gottaeat.customer.FoodItem food_item) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: food_item = (com.gottaeat.customer.FoodItem)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.gottaeat.customer.FoodItem getFoodItem() {
    return food_item;
  }
   ...
   * @param value the value to set.
   */
  public void setFoodItem(com.gottaeat.customer.FoodItem value) {
   ...
   */
  public static com.gottaeat.customer.OrderDetail.Builder newBuilder() {
    return new com.gottaeat.customer.OrderDetail.Builder();
  }
   ...
   * @return A new OrderDetail RecordBuilder
   */
  public static com.gottaeat.customer.OrderDetail.Builder newBuilder(com.gottaeat.customer.OrderDetail.Builder other) {
    if (other == null) {
      return new com.gottaeat.customer.OrderDetail.Builder();
    } else {
      return new com.gottaeat.customer.OrderDetail.Builder(other);
    }
  }
   ...
   * @return A new OrderDetail RecordBuilder
   */
  public static com.gottaeat.customer.OrderDetail.Builder newBuilder(com.gottaeat.customer.OrderDetail other) {
    if (other == null) {
      return new com.gottaeat.customer.OrderDetail.Builder();
    } else {
      return new com.gottaeat.customer.OrderDetail.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderDetail>
    ...
    private float total;
    private com.gottaeat.customer.FoodItem food_item;
    private com.gottaeat.customer.FoodItem.Builder food_itemBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.gottaeat.customer.OrderDetail.Builder other) {
      super(other);
      ...
      if (other.hasFoodItemBuilder()) {
        this.food_itemBuilder = com.gottaeat.customer.FoodItem.newBuilder(other.getFoodItemBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.gottaeat.customer.OrderDetail other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.quantity)) {
        this.quantity = data().deepCopy(fields()[0].schema(), other.quantity);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gottaeat.customer.OrderDetail.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gottaeat.customer.OrderDetail.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gottaeat.customer.OrderDetail.Builder setTotal(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gottaeat.customer.OrderDetail.Builder clearTotal() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gottaeat.customer.OrderDetail.Builder setFoodItem(com.gottaeat.customer.FoodItem value) {
     ...
     * @return This builder.
     */
    public com.gottaeat.customer.FoodItem.Builder getFoodItemBuilder() {
      if (food_itemBuilder == null) {
        if (hasFoodItem()) {
          setFoodItemBuilder(com.gottaeat.customer.FoodItem.newBuilder(food_item));
        } else {
          setFoodItemBuilder(com.gottaeat.customer.FoodItem.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.gottaeat.customer.OrderDetail.Builder setFoodItemBuilder(com.gottaeat.customer.FoodItem.Builder value) {
      clearFoodItem();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.gottaeat.customer.OrderDetail.Builder clearFoodItem() {
      food_item = null;
    ...
    public OrderDetail build() {
      try {
        ...
        if (food_itemBuilder != null) {
          ...
          record.food_item = fieldSetFlags()[2] ? this.food_item : (com.gottaeat.customer.FoodItem) defaultValue(fields()[2]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.food_item == null) {
        this.food_item = new com.gottaeat.customer.FoodItem();
      }
