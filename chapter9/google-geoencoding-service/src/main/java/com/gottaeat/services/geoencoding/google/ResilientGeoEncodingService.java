...
public class ResilientGeoEncodingService implements Function<Address, Void> {
	...
	private void init(Context ctx) {
		...
		rertyRegistry = RetryRegistry.of(retryConfig);
		retry = rertyRegistry.retry(ctx.getFunctionName());
